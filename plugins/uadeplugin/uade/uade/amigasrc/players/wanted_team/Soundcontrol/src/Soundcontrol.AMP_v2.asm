	...
	*****************************************************
	...
	dc.b	'$VER: Soundcontrol 3.0/3.2/4.0/5.0 player module V2.1 (25 Mar 2002)',0
	even
Tags
	...
	dc.l	EP_Flags,EPB_Save!EPB_ModuleInfo!EPB_SampleInfo!EPB_Packable!EPB_Restart!EPB_Songend!EPB_NextPatt!EPB_PrevPatt
	dc.l	0
