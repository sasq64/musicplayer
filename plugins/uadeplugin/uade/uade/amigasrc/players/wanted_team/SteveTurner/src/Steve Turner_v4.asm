	...
	****************************************************
	...
	dc.b	'$VER: Steve Turner player module V1.3 (17 June 2001)',0
	even
Tags
	...
	dc.l	EP_Flags,EPB_Volume!EPB_Balance!EPB_ModuleInfo!EPB_Voices!EPB_Save!EPB_Songend!EPB_Analyzer!EPB_NextSong!EPB_PrevSong!EPB_SampleInfo!EPB_Packable!EPB_Restart
	dc.l	0
...
SetAll
	...
	move.w	0(A4,D4.W),UPS_Voice1Per(A1)
	move.w	D1,UPS_Voice1Len(A1)
.no_A1
	cmp.w	#$B0,D0
	bne.b	.no_B1
	move.l	A0,UPS_Voice2Adr(A1)
	move.w	0(A4,D4.W),UPS_Voice2Per(A1)
	move.w	D1,UPS_Voice2Len(A1)

.no_B1
	cmp.w	#$C0,D0
	bne.b	.no_C1
	move.l	A0,UPS_Voice3Adr(A1)
	move.w	0(A4,D4.W),UPS_Voice3Per(A1)
	move.w	D1,UPS_Voice3Len(A1)
.no_C1
	cmp.w	#$D0,D0
	bne.b	.no_D1
	move.l	A0,UPS_Voice4Adr(A1)
	move.w	0(A4,D4.W),UPS_Voice4Per(A1)
	move.w	D1,UPS_Voice4Len(A1)
...
;	bmi.s	lbC0007EC				; looping song fix
