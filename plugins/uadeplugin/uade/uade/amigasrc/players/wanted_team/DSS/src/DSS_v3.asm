	***********************************************************
	****   Digital Sound Studio replayer for EaglePlayer   ****
	...
	***********************************************************
	...
	dc.b	'$VER: Digital Sound Studio 1.0-3.0 player module V1.2 (15 June 2002)',0
	even
Tags
...
Interrupt
	...
	lea	StructAdr(PC),A6
	st	UPS_Enabled(A6)
	clr.w	UPS_Voice1Per(A6)
	clr.w	UPS_Voice2Per(A6)
	clr.w	UPS_Voice3Per(A6)
	clr.w	UPS_Voice4Per(A6)
	move.w	#UPSB_Adr!UPSB_Len!UPSB_Per!UPSB_Vol,UPS_Flags(A6)

	bsr.w	Play

	clr.w	UPS_Enabled(A6)
...
lbC00054A	MOVE.B	5(A0),D0
	...
	BGE.S	lbC000558
	MOVEQ	#0,D0
lbC000558	MOVE.W	D0,8(A1)			; volume
	RTS
...
lbC000990	CMPI.B	#$17,2(A4)
	...
	BNE.S	lbC0009A6
	BSR.L	lbC000C52
lbC0009A6	MOVE.L	6(A4),(A3)		; address
	BEQ.S	lbC0009D2
