	******************************************************
	****   MultiMedia Sound replayer for EaglePlayer  ****
	...
	******************************************************
	...
	dc.b	'$VER: MultiMedia Sound (MMS.library V6.4) player module V1.0 (30 Sep 2007)',0
	even
Tags
	...
	dc.l	EP_Flags,EPB_Save!EPB_Volume!EPB_Balance!EPB_ModuleInfo!EPB_Voices!EPB_SampleInfo!EPB_Songend!EPB_Analyzer!EPB_Packable!EPB_Restart!EPB_PrevPatt!EPB_NextPatt!EPB_PrevSong!EPB_NextSong
