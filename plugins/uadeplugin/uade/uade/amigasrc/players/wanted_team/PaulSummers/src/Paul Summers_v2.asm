	*****************************************************
	****    Paul Summers replayer for EaglePlayer,	 ****
	...
	*****************************************************
	...
	dc.b	'$VER: Paul Summers player module V1.1 (25 Jan 2002)',0
	even
Tags
	...
	dc.l	EP_Flags,EPB_Volume!EPB_Balance!EPB_ModuleInfo!EPB_Songend!EPB_Analyzer!EPB_NextSong!EPB_PrevSong!EPB_Packable!EPB_Restart
	dc.l	0
...
NoVoice2
	...
	mulu.w	RightVolume(PC),D2
	lsr.w	#6,D2
	move.w	D2,UPS_Voice3Vol(A0)
	bra.b	SetIt
NoVoice3
	move.w	D2,OldVoice4
	mulu.w	LeftVolume(PC),D2
	lsr.w	#6,D2
	move.w	D2,UPS_Voice4Vol(A0)
SetIt
	move.w	D2,8(A3)
	move.l	(SP)+,A0
	rts
