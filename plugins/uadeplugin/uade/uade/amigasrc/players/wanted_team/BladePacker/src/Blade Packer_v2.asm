	*****************************************************
	****    Blade Packer replayer for EaglePlayer    ****
	...
	*****************************************************
	...
	dc.b	'$VER: Blade Packer player module V1.1 (13 Nov 2002)',0
	even
Tags
	...
	dc.l	EP_Flags,EPB_Save!EPB_Volume!EPB_Balance!EPB_ModuleInfo!EPB_LoadFast!EPB_Voices!EPB_SampleInfo!EPB_Songend!EPB_Analyzer!EPB_NextSong!EPB_PrevSong!EPB_Packable!EPB_Restart!EPB_PrevPatt!EPB_NextPatt
	dc.l	TAG_DONE
PlayerName
	dc.b	'Blade Packer',0
Creator
...
lbC034BD4	MOVE.L	lbL034838(PC),D0
	...
	SUBQ.L	#1,D1
	BSET	D1,$183(A6)
lbC034C18	MOVE.W	lbW03495E(PC),$DFF096
	BSET	#7,$182(A6)
	LEA	lbL0347EA(PC),A0
	LEA	$DFF0A6,A1
	LEA	lbL0348EA(PC),A2
...
;	move.w	(A0),UPS_Voice1Per(A4)

	MOVE.B	(A2),D1

	bsr.w	Left1
	move.w	D1,UPS_Voice1Vol(A4)

	MOVE.W	D1,(A3)				; Voice 1 volume
	BRA.S	lbC034C58

lbC034C4E	MOVE.W	$10(A0),(A1)		; Voice 1 period

;	move.w	$10(A0),UPS_Voice1Per(A4)
	...
	MOVE.W	D1,(A3)				; Voice 1 volume
lbC034C58	CMP.W	#2,D0
	BEQ.S	lbC034C6E
	MOVE.W	4(A0),$10(A1)			; Voice 2 period

;	move.w	4(A0),UPS_Voice2Per(A4)

	MOVE.B	4(A2),D1

	bsr.w	Right1
	move.w	D1,UPS_Voice2Vol(A4)

	MOVE.W	D1,$10(A3)			; Voice 2 volume
	BRA.S	lbC034C7C

lbC034C6E	MOVE.W	$10(A0),$10(A1)		; Voice 2 period

;	move.w	$10(A0),UPS_Voice2Per(A4)
	...
	MOVE.W	D1,$10(A3)			; Voice 2 volume
lbC034C7C	CMP.W	#3,D0
	BEQ.S	lbC034C92
	MOVE.W	12(A0),$20(A1)			; Voice 3 period

;	move.w	12(A0),UPS_Voice3Per(A4)

	MOVE.B	12(A2),D1

	bsr.w	Right2
	move.w	D1,UPS_Voice3Vol(A4)

	MOVE.W	D1,$20(A3)			; Voice 3 volume
	BRA.S	lbC034CA0

lbC034C92	MOVE.W	$10(A0),$20(A1)		; Voice 3 period

;	move.w	$10(A0),UPS_Voice3Per(A4)
	...
	MOVE.W	D1,$20(A3)			; Voice 3 volume
lbC034CA0	CMP.W	#4,D0
	BEQ.S	lbC034CB6
	MOVE.W	8(A0),$30(A1)			; Voice 4 period

;	move.w	8(A0),UPS_Voice4Per(A4)

	MOVE.B	8(A2),D1

	bsr.w	Left2
	move.w	D1,UPS_Voice4Vol(A4)

	MOVE.W	D1,$30(A3)			; Voice 4 volume
	BRA.S	lbC034CC4

lbC034CB6	MOVE.W	$10(A0),$30(A1)		; Voice 4 period

;	move.w	$10(A0),UPS_Voice4Per(A4)
...
;lbC034CC8	DBRA	D0,lbC034CC8
	...
	move.l	D0,UPS_Voice1Adr(A4)
	move.w	4(A0),UPS_Voice1Len(A4)
	move.w	(A3),UPS_Voice1Per(A4)
...
lbC034CE2	ADDQ.L	#6,A0
	...
	move.l	D0,UPS_Voice2Adr(A4)
	move.w	4(A0),UPS_Voice2Len(A4)
	move.w	4(A3),UPS_Voice2Per(A4)
...
lbC034CF2	ADDQ.L	#6,A0
	...
	move.l	D0,UPS_Voice3Adr(A4)
	move.w	4(A0),UPS_Voice3Len(A4)
	move.w	12(A3),UPS_Voice3Per(A4)
...
lbC034D02	ADDQ.L	#6,A0
	...
	move.l	D0,UPS_Voice4Adr(A4)
	move.w	4(A0),UPS_Voice4Len(A4)
	move.w	8(A3),UPS_Voice4Per(A4)

lbC034D12	MOVE.W	lbW03495E(PC),$DFF096
...
lbC034D68	MOVE.W	lbW03495E(PC),$DFF096
	LEA	lbW0347E8(PC),A0
	LEA	lbL034828(PC),A1
	LEA	lbL034990(PC),A2
	LEA	lbL034868(PC),A3
